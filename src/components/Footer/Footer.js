            ...
            <div className='max-w-screen-xl mx-auto px-4'>
                <div className=' flex max-w-xs mx-auto items-center justify-between'>
                    <a
                        ...
                        className='text-gray-400 hover:text-[#23A6F0] transition-colors duration-200'
                    >
                        <svg
                            width='20'
                            height='20'
                            fill='currentColor'
                            className='text-xl hover:text-[#23A6F0] transition-colors duration-200'
                ...
                <div className='text-center text-cyan-600 pt-10 sm:pt-12 font-light flex items-center justify-center'>
                    All Rights Reserved By &copy; GoHajj | 2022-2026
                </div>
            </div>
        </footer>
    )
