...
const Home = () => {
    return (
        <div>
            ...
            <section className='grid grid-cols-1 lg:grid-cols-2 p-6 h-screen'>

                {/* Banner Text */}
                <div className='my-auto order-2'>

                    <div className='text-left'>
                        <p className=' text-4xl lg:text-6xl font-semibold lg:font-[800]'>Hajj and Umrah!!</p>
                        <p className=' text-3xl lg:text-5xl text-[#23A6F0]'>The Journey of the Heart.</p>
                        <br />
                ...
                <div className='order-1 '>
                    ...
                    <div className="plane absolute top-[300px] lg:top-[250px] right-[50px] lg:right-[950px] w-[150px] md:w-[250px] -z-0 animate-[ping_2s_ease_infinite]">
